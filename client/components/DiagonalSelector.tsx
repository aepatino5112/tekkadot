...
const DiagonalSelector = () => {
  return (
    <section className="relative w-screen h-[55.438rem] overflow-visible -mx-10 mt-8 mb-30">
      ...
      <div className="absolute inset-0 z-30 pointer-events-none">
        <h2 className="absolute top-24 left-20 text-white-500 text-[10rem] font-black drop-shadow-lg drop-shadow-custom">
          PRODUCTS
        </h2>
        <h2 className="absolute bottom-24 right-20 text-white-500 text-[10rem] font-black drop-shadow-lg drop-shadow-custom">
          NFTs
        </h2>
      </div>
    </section>
