    ...
    return (
        <footer className="footer">
            <div className="relative flex flex-col items-start">
                <Image src="/logos/tekka-green.svg" alt="TekkaDot nfts light logo" width={278} height={75.14} className="block pb-9 dark:hidden" />
                <Image src="/logos/tekka-green-dark.svg" alt="TekkaDot nfts dark logo" width={278} height={75.14} className="hidden pb-9 dark:block" />
            ...
            <div className="flex justify-between items-start gap-30">
                <div className="footer-item mr-30">
                    <h5 className="text-lime-green-500 font-bold">MARKETPLACE</h5>
                ...
                <div className="footer-item mr-30">
                    <h5 className="text-lime-green-500 font-bold">ABOUT US</h5>
                ...
                <div className="footer-item mr-30">
                    <h5 className="text-lime-green-500 font-bold">LEGAL</h5>
